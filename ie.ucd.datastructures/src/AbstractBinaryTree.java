...
public abstract class AbstractBinaryTree<E> extends AbstractTree<E>
   ...
   * @return iterable collection of the tree's positions reported in in order
   */
  ...
  /**
   * Returns an iterable collection of the positions of the tree using in order traversal
   * @return iterable collection of the tree's positions using in order traversal
   */
  @Override
